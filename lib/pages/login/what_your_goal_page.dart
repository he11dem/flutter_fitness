...
class WhatYourGoalPage extends StatefulWidget {
  const WhatYourGoalPage({super.key});

  @override
  State<WhatYourGoalPage> createState() => _WhatYourGoalPageState();
}

class _WhatYourGoalPageState extends State<WhatYourGoalPage> {
  // dynamic userdoc;
